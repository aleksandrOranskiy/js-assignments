...
## Javascript Assignments  [![Build Status](https://travis-ci.org/aleksandrOranskiy/js-assignments.svg?branch=master)](https://travis-ci.org/aleksandrOranskiy/js-assignments)
